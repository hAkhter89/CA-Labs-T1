...
HD_PWD='C:/Users/sf10353/Downloads/lab_08/lab_08.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log addressDecoderTop.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source addressDecoderTop.tcl -notrace
