...
HD_PWD='C:/Users/sf10353/Downloads/lab_08/lab_08.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log addressDecoderTop.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source addressDecoderTop.tcl
