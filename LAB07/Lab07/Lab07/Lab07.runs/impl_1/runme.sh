...
HD_PWD='C:/Users/tau/Documents/Vivaldo docs/Lab07/Lab07.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log top_rf_alu.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source top_rf_alu.tcl -notrace
