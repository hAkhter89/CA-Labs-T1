...
HD_PWD='C:/Users/tau/Documents/Vivaldo docs/Lab07/Lab07.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log top_rf_alu.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source top_rf_alu.tcl
