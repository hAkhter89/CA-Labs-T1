...
HD_PWD='C:/Users/tau/Documents/Labs-CA-T1/LAB11/lab11.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log topProcessor.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source topProcessor.tcl -notrace
