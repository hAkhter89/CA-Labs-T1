...
HD_PWD='C:/Users/tau/Documents/Vivaldo docs/lab6/lab6.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log top_ALU.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source top_ALU.tcl -notrace
