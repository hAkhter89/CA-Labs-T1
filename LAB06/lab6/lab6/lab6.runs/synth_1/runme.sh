...
HD_PWD='C:/Users/tau/Documents/Vivaldo docs/lab6/lab6.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log top_ALU.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source top_ALU.tcl
